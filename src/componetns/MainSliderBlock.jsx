...
const MainSliderBlock = () => {
  ...
  const { isAuth, adminMode, createSlideMode, setCreateSlideMode, serverDomain } = React.useContext(AuthContext);
                    ...
                    <div className="block-main__slide slide-main-block">
                      <div className="slide-main-block__content">
                        <Link to="" className="slide-main-block__image">
                          ...
                          {isLoading ? <SliderSkeleton/> : <img src={`https://github.com/OlenaLiekan/bbb-server/blob/2f7a5bc1625e72c3bac2d901b8edddfadaaa194b/static/` + slide.img} alt="slide" /> }
                        </Link>
                      </div>
                    </div>
                  </SwiperSlide>
