...
const UserPanel = ({ user }) => {
    ...
    return (
        <div className={styles.body}>
            ...
            {createAddressMode && activeAuthOption === 1 ? <CreateAddress existingMainAddress={mainAddress} userId={currentUser.id} /> : ''}
            <div className={activeAuthOption === 1 && !updateAddressMode ? styles.userInfo : styles.hidden}>
                {!createAddressMode
                    ? 
            ...
            {updateAddressMode && activeAuthOption === 1 ? <UpdateAddress existingMainAddress={mainAddress} addresses={addresses} addressId={editAddressId} userId={currentUser.id} /> : ''}
            <button onClick={cancelAction} className={activeAuthOption === 1 && updateAddressMode ? styles.cancelBtn : styles.hidden}>Сancelar</button>
            <button onClick={cancelCreating} className={activeAuthOption === 1 && createAddressMode ? styles.cancelBtn : styles.hidden}>Cancelar</button>            
                        
            <div className={!updateUserMode && activeAuthOption === 2 && !updatePassMode && activeAuthOption === 2 ? styles.actions : styles.hidden}>
                <ul className={styles.userInfoTop}>
                    <li className={styles.infoLine}>
            ...
            {updateUserMode && activeAuthOption === 2 ? <UpdateUser userId={currentUser.id} /> : ''}
            {updatePassMode && activeAuthOption === 2 ? <UpdatePassword userId={currentUser.id} /> : '' }
            <button
                onClick={cancelEditData}
                className={(activeAuthOption === 2 && updateUserMode) || (activeAuthOption === 2 && updatePassMode)
                    ?
                    styles.cancelBtn
                    :
                    styles.hidden
