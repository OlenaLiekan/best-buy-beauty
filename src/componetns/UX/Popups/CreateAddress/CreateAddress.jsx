        ...
        <div className={styles.body}>     
            <form onSubmit={createNewAddress} id="createAddressForm" className={styles.addressForm}>
                <div className={styles.formLine}>
                    ...
                    <input required id="user-name-input" tabIndex="1" autoComplete="off" type="text" name="name" data-error="Error" placeholder='Primeiro Nome' className={styles.formInput}
                        ref={inputRef}
                        value={username}
                ...
                <div className={styles.formLine}>
                    ...
                    <input required id="user-surname-input" tabIndex="2" autoComplete="off" type="text" name="surname" data-error="Error" placeholder="Último Nome" className={styles.formInput}
                        ref={inputRef}
                        value={surname}
