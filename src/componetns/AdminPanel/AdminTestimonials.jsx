...
const AdminTestimonials = () => {
    ...
    const products = [
        {id: 154, name: "Cola Red"},
        {id: 300, name: "Pinca"},
        {id: 35, name: "KIT para limpeza das pestanas"},
    ];

    const users = [
        {id: 18, firstName: 'Olena'}
    ];

    const testimonials = [
        { id: 76, text: 'Super', createdAt: '2023-09-28 20:06:36.905+00', productId: 154, userId: 18 },
        { id: 77, text: 'Wow', createdAt: '2023-09-28 18:06:36.905+00', productId: 300, userId: 18 },
        { id: 78, text: 'Amazing', createdAt: '2023-09-14 10:06:36.905+00', productId: 35, userId: 18 },
    ];
        
    const answers = [
        { id: 1, text: 'Thanks', createdAt: '2023-09-28 20:06:36.905+00', reviewId: 76},
    ];
                            ...
                            <div className={styles.testimonialsComment}>
                                <div className={styles.testimonialsTop}>
                                    <div className={styles.testimonialsDate}>
                                        {(testimonial.createdAt).slice(0, 19)}
                                    </div>                                   
                                    <div className={styles.testimonialsTopLine}>
                                        ...
                                        <div className={styles.testimonialsName}>
                                            {users.find((user) => (user.id === testimonial.userId))?.firstName}
                                        </div>
                                    </div>                                
                                    <div className={styles.testimonialsTopLine}>
                                        <div className={styles.testimonialsProduct}>
                                            {products.find((product) => (product.id === testimonial.productId))?.name}                                        
                                        </div>
                                    </div>                                    
                                </div>
