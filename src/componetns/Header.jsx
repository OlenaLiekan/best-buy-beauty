...
const Header = () => {
  ...
  const [tickerIsLoading, setTickerIsLoading] = React.useState(false);
      ...
      <div className={scroll > 5 ? "header__body body-header body-header_fixed" : "header__body body-header"}>
        <div className="body-header__container">
          ...
          <div className="body-header__actions">
            ...
            <Link to="/favorites" onClick={() => closeSearch()} className={isFavoritesPage ? "actions-header__cart _icon-heart _icon-heart_red" : "actions-header__cart _icon-heart"}>
