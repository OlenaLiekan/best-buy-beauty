...
const Payment = () => {
    return (
        <div className="main__payment payment-main">
            <div className="payment-main__container">
                <div className="payment-main__content">
                    <h2 className="payment-main__title">
                        PAGAMENTO & ENTREGA
                    </h2>
                    <div className="payment-main__items items-payment">
                        <div className="payment-main__item">
                            ...
                            <p className="payment-main__text">
                                <span>1. </span>
                                Selecione os itens que você gosta e adicione ao carrinho.
                            </p>                            
                        </div>
                        <div className="payment-main__item">
                            ...
                            <p className="payment-main__text">
                                <span>2. </span> 
                                Faça seu pedido através do carrinho de compras e preencha os dados de entrega e feedback.
                            </p>                            
                        </div>
                        <div className="payment-main__item">
                            ...
                            <p className="payment-main__text">
                                <span>3. </span>
                                Pague as mercadorias usando os dados especificados e notifique-nos do pagamento.
                            </p>                            
                        </div>
                        <div className="payment-main__item">
                            ...
                            <p className="payment-main__text">
                                <span>4. </span> 
                                Iremos verificar a disponibilidade e integridade das mercadorias.
                            </p>                            
                        </div>                            
                        ...
                        <div className="payment-main__item">
                            ...
                            <p className="payment-main__text">
                                <span>5. </span> 
                                Nosso especialista entrará em contato com você se tivermos alguma dúvida sobre seu pedido.
                            </p>                            
                        </div>
                        <div className="payment-main__item">
                            ...
                            <p className="payment-main__text">
                                <span>6. </span> 
                                Enviaremos seu pedido por serviço de entrega dentro de 1-3 dias.
                            </p>                            
                        </div>                            
                    </div>
                </div>
